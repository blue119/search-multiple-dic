...
// Allow audio playback in embedded dictionary webviews (Linux often blocks autoplay).
app.commandLine.appendSwitch(
  "disable-features",
  "AudioServiceSandbox,AudioServiceOutOfProcess",
);
...
function createWindow() {
  ...
  mainWindow.webContents.on("did-attach-webview", (event, guestWebContents) => {
    guestWebContents.setAudioMuted(false);
  });
